...
class TestS3Handler:
    ...
    @patch("parquetframe.cloud.handlers.s3.S3Handler._check_rust_s3")
    ...
    @patch("parquetframe.cloud.handlers.s3.pd.read_parquet")
    ...
    @patch("parquetframe.cloud.handlers.s3.S3Handler._read_rust")
...
class TestUserAPI:
    ...
    def test_read_parquet_s3(self, mock_get_handler):
    ...
    @patch("parquetframe.cloud.factory.CloudFactory.get_handler")
    def test_write_parquet_s3(self, mock_get_handler):
        ...
        mock_handler.write_parquet.assert_called_once_with(
            df, "s3://bucket/out.parquet", aws_profile="dev"
        )
